    ...
    for filename in os.listdir(folder_path):
        ...
        if os.path.isfile(file_path):
            ...
            if extracted_text is not None:
                ...
                entities = extract_entities(extracted_text) #extract entities from preprocessed text. "preprocessed_text": preprocessed_text, "preprocessed_text": None,
                data.append({"job_title": filename, "extracted_raw_text": extracted_text, "entities": entities}) 
            # else:
            #     data.append({"job_title": filename, "extracted_raw_text": extracted_text, "entities": entities})
